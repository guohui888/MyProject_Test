...
public class PickPhoto {
	...
	public static final int QQ_LOGIN = 3025;
	...
	/** 拍照后剪切 */
	public static void getCropIntent(Activity activity, String path, int width,
			int height) {
	...
	public static void setRestFile() {
		...
		name = dateFormat.format(new Date(time)) + "_"
				+ name.substring(name.length() - 6, name.length()) + ".jpg";
		try {
