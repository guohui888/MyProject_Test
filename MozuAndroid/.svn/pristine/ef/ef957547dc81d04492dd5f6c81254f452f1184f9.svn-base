...
public class FriendshipsAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void create( String access_token, String screen_name, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
	 ...
	 * @param listener
	 */
	public void destroy( String access_token, String screen_name, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("access_token", access_token);
		params.add("screen_name", screen_name);
