...
public class Constant {
	...
	public static final String DB_NAME = "mouth.db";// 数据库名称
	...
	public static final String weixin_APP_ID = "wx2cdc3f16c1635bad";

	public static final String QQ_APP_ID = "101045981";

	public static final String SINA_APP_ID = "8012880";// 8012880

	// public static final String SINA_APP_KEY =
	// "149a37ae7d9ee2228279bab91afe5afb";

	// public static final String SINA_APP_ID = "295804500";
	//
	// public static final Strin g SINA_APP_KEY =
	// "6ae41c84e87f6e4570242acafca61a73";
	...
	public static final String UPDATE_VERSION_URL = "http://120.31.131.190:8017/apk/version.xml";

	// public static final String HOST_URL = "http://app.52dzb.com";

	public static final String HOST_URLS = "http://app.52dzb.com/";

	public static final String IMAGE_URL = "http://www.mzzkd.com/";
	// http://zcimg.zcool.com.cn/zcimg/c_m_6019533775bf00000163051c0f3d.jp

	public static final String HOME_IMAGE_URL = "http://www.mzzkd.com/data/afficheimg/";

	/** 商品描述 **/
	public static final String PRODUCT_DETAIL_ONE = "http://www.mzzkd.com/ajax_home.php?act=getGoodInfo&id=";

	/** 商品文章 **/
	public static final String PRODUCT_DETAIL_THREE = "http://www.52dzb.com/ajax_home.php?act=getArtCon&id=";

	/** WebService地址 **/
//	public static final String WEB_SERVER_URL = "http://app.52dzb.com/WebService.asmx";
	// public static final String WEB_SERVER_URL =
	// "http://116.255.138.164:8010/WebService.asmx";
	// public static final String WEB_SERVER_URL =
	// http://116.255.138.164:8010/WebService.asmx

	public static final String WEB_SERVER_URL = "http://120.31.131.190:8017/WebService1.asmx";
	...
	/** 添加到购物车 **/
	public static final String S_AddCart = "S_AddCart";

	/** 改变购物车商品的数量 **/
	public static final String S_UpdateCartNumber = "S_UpdateCartNumber";

	/** 删除购物商品 **/
	public static final String S_DeleteCart = "S_DeleteCart";

	/** 购物车列表 **/
	public static final String S_CartList = "S_CartList";
	...
	/** 添加订单 **/
	public static final String S_AddOrder = "S_AddOrder";
