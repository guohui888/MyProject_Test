...
public class AddressInfo implements Serializable {
	...
	public String toString() {
		return "AddressInfo [address_id=" + address_id + ", consignee="
				+ consignee + ", email=" + email + ", province=" + province
				+ ", city=" + city + ", district=" + district + ", address="
				+ address + ", zipcode=" + zipcode + ", tel=" + tel
				+ ", mobile=" + mobile + ", sign_building=" + sign_building
				+ ", best_time=" + best_time + "]";
	}
