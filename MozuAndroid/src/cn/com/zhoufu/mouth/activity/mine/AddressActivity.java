...
public class AddressActivity extends BaseActivity {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		// if (list1.get(arg2).getCity() == null) {
		// Intent i = new Intent(this, AddAddressActivity.class);
		// i.putExtra("tag", "2");
		// i.putExtra("info", list1.get(arg2));
		...
		delete.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (application.getUser().getUser_id() != 0) {
					...
					AddreInfo addinfo = list1.get(position);
					list1.remove(addinfo);
	...
	public void finish() {
		Intent intent = new Intent(mContext, SureOrderActivity.class);
		if (application.getUser().getUser_id() != 0 && list.size() > 0) {
