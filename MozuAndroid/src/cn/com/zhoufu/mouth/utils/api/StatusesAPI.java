...
public class StatusesAPI extends WeiboAPI {
	 ...
	 * @param listener
	 */
	public void friendsTimeline(int since_id, int max_id, int count, int page,
			int i, int j, int k, RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
	 ...
	 * @param listener
	 */
	public void repost(long id, String status, int is_comment,
			RequestListener listener) {
		WeiboParameters params = new WeiboParameters();
		params.add("id", id);
